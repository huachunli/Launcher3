...
public class Launcher extends Activity
    ...
    private RgkSateLiteModel rgkSateLiteModel;
    /**
...
//            REQUEST_EXTERNAL_STORAGE);
    ...
    public void onCreateContinue(Bundle savedInstanceState) {
        ...
        startService(new Intent(Launcher.this, RgkSateLiteService.class));
...
catch (NullPointerException e)
{
    ...
    private void setupViews() {
        ...
        mWorkspacePreview = (RGKWorkspacePreviewScrollLayout) findViewById(R.id.wrokspce_preview);// Add by yeyu for screen edit 20160910
...
catch (NullPointerException e)
{
    ...
    private boolean startActivity(View v, Intent intent, Object tag) {
        //add by luoran(start)
        Intent rgkIntent = new Intent();
        rgkIntent.setAction(Utilities.RECENT_ACTION);
        Bundle bundle = new Bundle();
        if (intent != null) {
            bundle.putString("intent", intent.toUri(0));
            rgkIntent.putExtras(bundle);
            sendBroadcast(rgkIntent);
        }
        //add by luoran(end)
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        try {
...
//                Toast.makeText(this, com.mediatek.internal.R.string.denied_required_permission,
    ...
    private LinearLayout addDragGridView(int index) {
        ...
        mDragGridView.setHorizontalSpacing(mDeviceProfile.previewHSpace);
        mDragGridView.setVerticalSpacing(mDeviceProfile.previewVSpace);
